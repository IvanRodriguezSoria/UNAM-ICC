...
public class Estudiante implements Registro {
    ...
    @Override public boolean equals(Object o) {
      ...
      return (nombre.equals(estObj.nombre) && cuenta == estObj.cuenta &&
              promedio == estObj.promedio && edad == estObj.edad);
    }
    ...
    @Override public boolean carga(BufferedReader in) throws IOException {
      ...
      try{
        cuenta = Integer.parseInt(splitedString[1]);
        promedio = Double.parseDouble(splitedString[2]);
        edad = Integer.parseInt(splitedString[3]);
